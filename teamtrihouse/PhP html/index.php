            ...
            <div class="content col-lg-8 vh-100 p-0">
                <div class="d-flex flex-column">
                    ...
                    <section class="pl-5">
                        ...
                        <p class="lead"><?php echo askName("akbarkurnia"); ?></p>
                    </section>
                </div>
                ...
                <div class="d-flex flex-column position-absolute fixed-bottom">
                    <p class="font-weight-normal text-center">&copy; <?php echo "Akbar\t"; echo "last modified:\t".date("F d Y H:i:s",getlastmod()); ?></p>
                </div>
            </div>
